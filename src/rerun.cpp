...
void Rerun::command(int narg, char **arg)
{
  ...
  if(0 == modify->n_fixes_style("particledistribution/discrete"))
    error->all(FLERR,"Rerun command needs the fix particledistribution/discrete from the original simulation to be defined");
