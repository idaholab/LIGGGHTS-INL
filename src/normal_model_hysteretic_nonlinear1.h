...
#ifdef NORMAL_MODEL
NORMAL_MODEL(HYSTERETIC_NONLINEAR1,hysteretic/nonlinear1,15)
#else
#ifndef NORMAL_MODEL_HYSTERETIC_NONLINEAR1_H_
#define NORMAL_MODEL_HYSTERETIC_NONLINEAR1_H_
...
{
  template<>
  class NormalModel<HYSTERETIC_NONLINEAR1> : public NormalModelBase
  {
  public:
    ...
    void connectToProperties(PropertyRegistry & registry) {
      registry.registerProperty("K_elastic", &MODEL_PARAMS::createLoadingStiffness,"model hysteretic/nonlinear1");
      registry.registerProperty("CoeffRestLog", &MODEL_PARAMS::createCoeffRestLog,"model hysteretic/nonlinear1");
      registry.registerProperty("kn2k1", &MODEL_PARAMS::createUnloadingStiffness,"model hysteretic/nonlinear1");
      registry.registerProperty("kn2kc", &MODEL_PARAMS::createCoeffAdhesionStiffness,"model hysteretic/nonlinear1");
      registry.registerProperty("phiF", &MODEL_PARAMS::createCoeffPlasticityDepth,"model hysteretic/nonlinear1");
      registry.registerProperty("f_adh", &MODEL_PARAMS::createPullOffForce,"model hysteretic/nonlinear1");
      //hysteretic nonlinear1 model properties
      registry.registerProperty("Alpha", &MODEL_PARAMS::createAlphaCustom,"model hysteretic/nonlinear1");
      registry.registerProperty("Cin", &MODEL_PARAMS::createCinCustom,"model hysteretic/nonlinear1");
      registry.registerProperty("A1", &MODEL_PARAMS::createAoneCustom,"model hysteretic/nonlinear1");
      registry.registerProperty("A2", &MODEL_PARAMS::createAtwoCustom,"model hysteretic/nonlinear1");
      registry.registerProperty("A3", &MODEL_PARAMS::createAthreeCustom,"model hysteretic/nonlinear1");
      registry.registerProperty("kcin", &MODEL_PARAMS::createKcinCustom,"model hysteretic/nonlinear1");

      //

      registry.connect("K_elastic", K_elastic,"model hysteretic/nonlinear1");
      registry.connect("CoeffRestLog", CoeffRestLog,"model hysteretic/nonlinear1");
      registry.connect("kn2kc", kn2kc,"model hysteretic/nonlinear1");
      registry.connect("kn2k1", kn2k1, "model hysteretic/nonlinear1");
      registry.connect("phiF", phiF,"model hysteretic/nonlinear1");
      registry.connect("f_adh", f_adh,"model hysteretic/nonlinear1");
      //hysteretic nonlinear1 model properties
      registry.connect("Alpha", Alpha,"model hysteretic/nonlinear1");
      registry.connect("Cin", Cin,"model hysteretic/nonlinear1");
      registry.connect("A1", A1,"model hysteretic/nonlinear1");
      registry.connect("A2", A2,"model hysteretic/nonlinear1");
      registry.connect("A3", A3,"model hysteretic/nonlinear1");
      registry.connect("kcin", kcin,"model hysteretic/nonlinear1");

      //

      // error checks on coarsegraining
      if(force->cg_active())
        error->cg(FLERR,"model hysteretic/nonlinear1");
    }
    ...
    void surfacesIntersect(SurfacesIntersectData & sidata, ForceData & i_forces, ForceData & j_forces)
    {
      ...
      // input parameters for hysteretic/nonlinear1 model: Alpha, Cin, A1, A2, A3, CoeffGn, k_c
      //double Alpha_in = 20;
      //double Cin = 1.0e-7;
...
#endif // NORMAL_MODEL_HYSTERETIC_NONLINEAR1_H_
#endif
