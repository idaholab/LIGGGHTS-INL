...
#ifdef ROLLING_MODEL
ROLLING_MODEL(ROLLING_CDTNONLINEAR2,cdtnonlinear2,7)
#else
#ifndef ROLLING_MODEL_CDTNONLINEAR2_H_
#define ROLLING_MODEL_CDTNONLINEAR2_H_
...
namespace ContactModels
{
  ...
  template<>
  class RollingModel<ROLLING_CDTNONLINEAR2> : public RollingModelBase {
  public:
    ...
    void connectToProperties(PropertyRegistry & registry)
    {
      ...
      registry.connect("coeffRollFrict", coeffRollFrict,"rolling_model cdtnonlinear2");

      // error checks on coarsegraining
      if(force->cg_active())
        error->cg(FLERR,"rolling model cdtnonlinear2");
    }
    ...
    void surfacesIntersect(SurfacesIntersectData & sidata, ForceData & i_forces, ForceData & j_forces) 
    {
      ...
      if(sidata.is_wall){
        ...
        if(wr_rollmag > 0.)
        {
          ...
          vectorScalarMult3D(wr_roll,rmu*Fn*reff/wr_rollmag,r_torque);
...
#endif // ROLLING_MODEL_CDTNONLINEAR2_H_
#endif
